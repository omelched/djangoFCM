...
SECRET_KEY = 'django-insecure-9*ax!)3sz)ge2k6amkah_-2ehl7x9rny9y)wfh8@%_*&$8ke=h'
...
DJANGOFCM_HMS_CLIENT_ID = os.environ.get("DJANGOFCM_HMS_CLIENT_ID", "SECRET")
DJANGOFCM_HMS_SECRET = os.environ.get("DJANGOFCM_HMS_SECRET", "SECRET")
DJANGOFCM_HMS_PROJECT_ID = os.environ.get("DJANGOFCM_HMS_PROJECT_ID", "SECRET")
